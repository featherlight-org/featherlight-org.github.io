...
BLOG_AUTHOR = "JP Viljoen"  # (translatable)
BLOG_TITLE = "Featherlight Consulting"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://featherlight-org.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://featherlight.github.io/"
BLOG_EMAIL = "hello@featherlight.ly"
BLOG_DESCRIPTION = "Featherlight Consulting - A solutions provider"  # (translatable)
